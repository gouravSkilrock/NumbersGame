...
@PrepareForTest({ ServletActionContext.class, CookieMgmtForTicketNumber.class, Util.class, ActionContext.class,
		TransactionManager.class, Utility.class })
public class KenoTwoActionIT {
	...
	private KenoTwoAction oneMethod(String json) throws IOException, Exception {
		...
		powermockUtilCalssMethods();
		mockStatic_Servlet_ActionContext();
	...
	private void mockStatic_Servlet_ActionContext() throws Exception {
	...
	private void powermockUtilCalssMethods() throws Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForPerm1AdvanceQP() throws Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForPerm2AdvanceQP() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForPerm3AdvanceQP() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForPerm3Manual() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect1Manual() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect2Manual() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect3QP() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect3Manual() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect4QP() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect4Manual() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect5QP() throws IOException, Exception {
	...
	@Test
	public void purchaseTicketProcess_returnsSuccessForDirect5Manual() throws IOException, Exception {
