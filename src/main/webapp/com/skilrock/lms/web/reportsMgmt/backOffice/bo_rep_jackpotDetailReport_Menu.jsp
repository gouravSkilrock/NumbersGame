...
<script type="text/javascript" src="<%=request.getContextPath()%>/com/skilrock/lms/web/drawGames/reportsMgmt/backOffice/js/report.js"></script>
		<script> 
			function validate() {
				var game=$("#gameNo").val();
				if(game==-1){
					//$("#error").html(<font color = 'red'>"Please select the game name."</font>);
					_id.o("error").innerHTML = "<font color = 'red'>"+i18nOb.prop('error.entr.game.name')+"</font>";
					return false;
				}else{
					$("#error").html("");
					return true;
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					Jackpot Detail Report
				</h3>


				<s:form name="searchgame" action="bo_rep_jackpotDetailReport_success" onsubmit="return validate()">
						...
						<tr>
							<td colspan="2">
								...
								<s:select name="gameNo" id="gameNo" theme="simple"
									...
									cssStyle="margin-left:10px; width:150px"/>
							</td>
						</tr>
						<tr>
							<td colspan="2">
...
<code id="headId" style="visibility: hidden">
	$RCSfile: bo_rep_jackpotDetailReport_Menu.jsp,v $ $Revision:
