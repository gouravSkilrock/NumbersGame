...
var table="<table border='1' cellpadding='0' cellspacing='0' bordercolor='CCCCCC' style='border-color: green;' width='90%'>"+
				"<tr><th align='center'>"+i18nObj.prop('label.scratch.reports.no.of.books')+"</th><th align='center'>"+i18nObj.prop('label.scratch.reports.no.of.books')+"</th><th align='right'>"+paginationSelect+"</th></tr>";
	//alert(start+" === "+end);
	//alert(parseInt(start,10)<parseInt(end,10));
	for(var i=parseInt(start,10); i<parseInt(end,10); i++) {
		var newRow="<tr>"+
						"<td align='left'>"+i18nObj.prop('label.scratch.reports.pack')+" - "+packList[i]+"</td>"+
						"<td align='left'>"+i18nObj.prop('label.scratch.reports.no.of.books')+" = "+booksInPack[i]+"</td>"+
						"<td align='right'>"+
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/reportsMgmt/backOffice/js/inventoryBooksDetails.js,v $'] = '$Id: inventoryBooksDetails.js,v 1.2 2016/10/31 09:46:26 neeraj Exp $';