...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<style>
	#welcome-header{background-color: #efba01;}
	</style>
	<head>
	...
	<link rel="stylesheet"
			href="<%=request.getContextPath()%>/LMSImages/css/safaribet.css"
			"type="text/css" />
</s:if>
...
function vsClick(){
	...
	if(isopen=="false"){
		 ...
		 if(ownerType=='RETAILER'){
		 		      ...
		 		      myWindow = window.open("<%=request.getContextPath()%>/com/skilrock/lms/web/loginMgmt/openVSPage.action?userType=RETAILER",'_blank',"width=1500, height=1000");
		 }
	}         
}
...
<code id="headId" style="visibility: hidden">
	$RCSfile: Header.jsp,v $ $Revision: 1.29 $
</code>