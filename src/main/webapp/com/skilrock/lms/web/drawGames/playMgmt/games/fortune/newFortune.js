var fortInpTxt='input type="text" maxlength="3" style="font-size: 13px; width: 45px;" onblur="fortBlur()" onkeydown="return keyPressFort(this)" onkeyup="return keyPressFort(this)" onmousedown="return disClick(this)"';
...
function _fortuneFillNxtDrw(){
	...
	if(i%2==0){rowcolor="#d5faa9";}else{rowcolor="#9ACD5E";}		
