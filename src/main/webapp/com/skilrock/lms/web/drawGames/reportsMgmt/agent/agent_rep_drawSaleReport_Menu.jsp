	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				...
				<s:form action="agent_rep_drawSaleReport_Search" onsubmit="return validateDates()">
						...
						<tr>
							<td align="center" colspan="2">
								...
								<div id="date"
									...
									<s:div id="newDates" theme="ajax" href="%{request.getContextPath()}/com/skilrock/lms/web/reportsMgmt/rep_common_fetchLastMonthSpanDate.action">
									</s:div>
								</div>
							</td>
