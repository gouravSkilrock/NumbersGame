				...
				<s:if test="%{#session.TKT_WIN_STATUS!=null}">
					...
					<table width="125%" border="1" cellpadding="3" cellspacing="0"
						...
						<tr class="data">
							...
							<td align="center"><%=drawBean.getDrawStatusForticket().replace("_", " ")%></td>
									...
									<tr>
										...
										<%
											if ("Keno".equalsIgnoreCase(Util.getGameType(gameId))
												|| "Zimlottotwo".equalsIgnoreCase(Util.getGameName(gameId))
												|| "bonusballtwo".equalsIgnoreCase(Util.getGameName(gameId))
												|| "SuperTwo".equalsIgnoreCase(Util.getGameName(gameId))
												|| "ZimLottoBonusTwo".equalsIgnoreCase(Util.getGameName(gameId))
												|| "ZimLottoBonusTwoFree".equalsIgnoreCase(Util.getGameName(gameId))
												|| "RainbowGame".equalsIgnoreCase(Util.getGameName(gameId))
												|| "pickThree".equalsIgnoreCase(Util.getGameName(gameId))
												|| "pickFour".equalsIgnoreCase(Util.getGameName(gameId))) {
										%>
										<th>
									...
									<tr class="data">
										...
										<%
											if ("Keno".equalsIgnoreCase(Util.getGameType(gameId))
																...
																|| "pickFour".equalsIgnoreCase(Util.getGameName(gameId))) {
										%>
										<td><%=panelBean.getBetDispName()%></td>
