...
<div id="wrap">
  ...
  <div id="top_form">
	...
	<br/>
	<br/>
			<table width="80%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC">
	    ...
	    <table border="0" width="80%"  align="center" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC">
...
<div style="width: 90%;margin-top: 10px;">
				<s:submit value="Proceed to Next Game" action="agt_im_assignOrder_ProceedNxtGame"
					onclick=" return verifyEntry()" cssClass="button"/></div>
...
$RCSfile: agt_im_assignOrder_DispatchGame.jsp,v $
$Revision: 1.3 $
</code>