...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body onload="">
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					<s:text name="Order: Book Recieve" />
				</h3>

				<s:form name="bookRecieve" action="ret_om_bookRecieveRegistration_getBooks" onsubmit="return validateForm()">
...
<code id="headId" style="visibility: hidden">
	$RCSfile: ret_om_bookRecieveRegistration_menu.jsp,v $ $Revision:
	1.1.2.1.8.4.8.1.2.1 $
</code>