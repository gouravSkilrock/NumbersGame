...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					Order Process : Book Assigning
				</h3>
				<s:form action="agt_im_assignOrder_Save">
					<p>
						&nbsp;
					</p>
					<table width="100%" border="1" align="center" cellpadding="3" bordercolor="#CCCCCC"
						cellspacing="0">
						<tr>
							<td>
								<table width="100%">
									...
									<tr>
										...
										<td>
											<s:set name="strCreditLimit" value="%{#session.CREDIT_LIMIT}" /><%=FormatNumber.formatNumberForJSP(pageContext.getAttribute("strCreditLimit"))%></td>
										<th>
					...
					<table align="center" border="1">
						<table align="center" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC">
							<tr>
								...
								<th>
									Number of Books To Dispatch
								</th>
								<th>
									No of Books Already Dispatched
								</th>
								<th>
									No of books Remaining to Dispatch
								</th>
							</tr>
							<s:iterator value="#session.AGT_APP_ORDER_GAME_LIST" status="appStatus">
								<tr>
									...
									<s:else>
										<td>
											<s:a href="agt_im_assignOrder_OrderGameDetail.action?gameId=%{gameId}">
												<s:property value="gameNbr" />
											</s:a>
										</td>
									</s:else>
						...
						<s:if test="%{isDispatch}">
							...
							<s:submit value="Assign Order" cssClass="button" id="subTrans" onclick="return _subValid(this.id);" />
						</s:if>
					</table>
				</s:form>
			</div>
...
<code id="headId" style="visibility: hidden">
	$RCSfile: agt_im_assignOrder_OrderDisplay.jsp,v $ $Revision: 1.3 $
</code>