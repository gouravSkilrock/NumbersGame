...
public class TallyXMLBankDepositBean {
		...
		public static class ImportData {
			...
			public static class RequestData {
				...
				public static class TallyMessage {
					...
					@XmlAccessorType(XmlAccessType.NONE)
					@XmlType(propOrder = {"bankersDate","date", "guid", "narration",
					...
					public static class Voucher {
						...
						private String hasCashFlow = "Yes";
						...
						private List<AllBankersDate> bankersDate;
						...
						public List<AllBankersDate> getBankersDate() {
							return bankersDate;
						}
						
						@XmlElement(name = "BASICBANKERSDATE.LIST", type = AllBankersDate.class)
						public void setBankersDate(List<AllBankersDate> bankersDate) {
							this.bankersDate = bankersDate;
						}

						@XmlAccessorType(XmlAccessType.NONE)
						public static class AllBankersDate{
							private String type="Date";
							private String basicBankersDate;
							...
							public String getBasicBankersDate() {
								return basicBankersDate;
							}

							@XmlElement(name = "BASICBANKERSDATE")
							public void setBasicBankersDate(String basicBankersDate) {
								this.basicBankersDate = basicBankersDate;
							}
