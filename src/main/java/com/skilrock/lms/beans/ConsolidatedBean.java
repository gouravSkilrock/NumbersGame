...
public class ConsolidatedBean {
	...
	private double purchPrcRemRetStk = 0.0;
	...
	public double getPurchPrcRemRetStk() {
		return purchPrcRemRetStk;
	}
	...
	public void setPurchPrcRemRetStk(double purchPrcRemRetStk) {
		this.purchPrcRemRetStk = purchPrcRemRetStk;
	}
