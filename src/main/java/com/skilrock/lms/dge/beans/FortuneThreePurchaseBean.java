...
public class FortuneThreePurchaseBean extends CommonPurchaseBean implements Serializable {
	...
	private List<String>[] pickedNumbers;
	...
	public List<String>[] getPickedNumbers() {
		return pickedNumbers;
	}
	public void setPickedNumbers(List<String>[] pickedNumbers) {
