...
public class KenoPurchaseBean  implements
		Serializable {
	...
	public FortunePurchaseBean getFortunePurchaseBean() {
	...
	public void setFortunePurchaseBean(FortunePurchaseBean fortunePurchaseBean) {
		this.fortunePurchaseBean = fortunePurchaseBean;
	}
