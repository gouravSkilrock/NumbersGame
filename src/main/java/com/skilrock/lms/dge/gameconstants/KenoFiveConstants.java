...
public class KenoFiveConstants {
	...
	public static String GAME_NAME = "kenoFive";
	...
	public static List<String> KENO_FIVE_DRAWNAME_LIST = new ArrayList<String>();
	...
	static {
		...
		BET_TYPE_MAP.put("Banker1AgainstAll", 1);
		BET_TYPE_MAP.put("MN-BankerULMIN", 1);
		BET_TYPE_MAP.put("MN-BankerULMAX", 4);
		BET_TYPE_MAP.put("MN-BankerBLMIN", 1);
		BET_TYPE_MAP.put("MN-BankerBLMAX", 20);
		BET_TYPE_MAP.put("4By90-Direct2", 2);
		BET_TYPE_MAP.put("3By90-Direct2", 2);
		BET_TYPE_MAP.put("2By90-Direct2", 2);
		BET_TYPE_MAP.put("4By90-Perm2MIN", 3);
		BET_TYPE_MAP.put("4By90-Perm2MAX", 20);
		BET_TYPE_MAP.put("3By90-Perm2MIN", 3);
		BET_TYPE_MAP.put("3By90-Perm2MAX", 20);
		BET_TYPE_MAP.put("2By90-Perm2MIN", 3);
		BET_TYPE_MAP.put("2By90-Perm2MAX", 20);
	}
	//this method is depricated and not used commented on 11 april 2013 by sumit
	/*static {
	...
	*/
	static{
		...
		KENO_FIVE_DRAWNAME_LIST.add("GOLD COAST");
		KENO_FIVE_DRAWNAME_LIST.add("INTERNATIONAL");
		KENO_FIVE_DRAWNAME_LIST.add("CONTINENTAL");	
		KENO_FIVE_DRAWNAME_LIST.add("WINLOT SPECIAL");	
		KENO_FIVE_DRAWNAME_LIST.add("ROYAL CASH");	
		KENO_FIVE_DRAWNAME_LIST.add("WINLOT ULTIMATE");	
		KENO_FIVE_DRAWNAME_LIST.add("WINLOT JACKPOT");	
		KENO_FIVE_DRAWNAME_LIST.add("MEGA CASH");		
		}
