...
public class GameMasterBean implements Serializable {
	...
	public void setGovtClaimComm(double govtClaimComm) {
		this.govtClaimComm = govtClaimComm;
	}

	@Override
	public String toString() {
		return "GameMasterBean [gameId=" + gameId + ", gameNo=" + gameNo
				+ ", merchantId=" + merchantId + ", gameDevName=" + gameDevName
				+ ", gameDispName=" + gameDispName + ", maxTicketAmt="
				+ maxTicketAmt + ", thersholdTickerAmt=" + thersholdTickerAmt
				+ ", minBoardCount=" + minBoardCount + ", maxBoardCount="
				+ maxBoardCount + ", displayOrder=" + displayOrder
				+ ", gameStatus=" + gameStatus + ", govtClaimComm="
				+ govtClaimComm + "]";
	}
