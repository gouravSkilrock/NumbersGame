...
public class VSErrors {
	...
	public static final String GAME_NOT_AVAILABLE_ERROR_MESSAGE = "Game Not Available";
	...
	public static final String INACTIVE_RETAILER_ERROR_MESSAGE = "Inactive Retailer. Please Contact to Your AGENT!!";
	public static final int INACTIVE_RETAILER_ERROR_CODE = 160;
	
	public static final String INACTIVE_AGENT_ERROR_MESSAGE = "Inactive Agent. Please Contact to BO!!";
	public static final int INACTIVE_AGENT_ERROR_CODE = 161;
	...
	public static final int NO_REQUEST_DATA_PROVIDED_ERROR_CODE = 101;
	
	public static final String INTERNAL_SYSTEM_ERROR_MESSAGE = "Internal System Error !!";
	public static final int INTERNAL_SYSTEM_ERROR_CODE = 102;

	public static final int UNAUTHORIZED_VB_USER_ERROR_CODE = 103;
	public static final String UNAUTHORIZED_VB_USER_ERROR_MESSAGE = "Unauthorized User";

	public static final int NO_SHOP_FOUND_ERROR_CODE = 104;
	public static final String NO_SHOP_FOUND_ERROR_MESSAGE = "Unit doesnot exists!";
	
	public static final int PROPER_REQUEST_DATA_INVALID_ERROR_CODE = 105;
	public static final String PROPER_REQUEST_DATA_INVALID_ERROR_MESSAGE = "Proper Request Data Not Provided";
	
	public static final int AUTHENTICATION_FAILED_ERROR_CODE = 106;
	public static final String AUTHENTICATION_FAILED_ERROR_MESSAGE = "Unauthorized Request";
	...
	public static final String RG_LIMIT_EXCEPTION_ERROR_MESSAGE = "Responsible Gaming Limit Reached !!!";
