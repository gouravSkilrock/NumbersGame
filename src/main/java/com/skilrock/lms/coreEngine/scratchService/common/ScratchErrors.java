...
public class ScratchErrors {
	...
	public static final String INVALID_TICKET_NUMBER_MESSAGE = "Invalid Ticket Number";
	...
	public static final String SCRATCH_GAME_NOT_AVAILABLE_ERROR_MESSAGE = "Scratch Game Not Available";
	public static final int SCRATCH_GAME_NOT_AVAILABLE_ERROR_CODE = 140;
	
	public static final String SCRATCH_BOOK_NOT_AVAILABLE_ERROR_MESSAGE = "Scratch Book Not Available";
	public static final int SCRATCH_BOOK_NOT_AVAILABLE_ERROR_CODE = 141;
	
	public static final String SCRATCH_INVALID_INVOICE_MENTHOD_VALUE_TYPE_ERROR_MESSAGE = "Invalid Scratch Invoice Method Value Type";
	public static final int SCRATCH_INVALID_INVOICE_MENTHOD_VALUE_TYPE_ERROR_CODE = 141;
	...
	public static final int NO_REQUEST_DATA_PROVIDED_ERROR_CODE = 508;
	
	public static final String NO_REQUEST_ID_PROVIDED_ERROR_MESSAGE ="No Request Data Provided !";
	public static final int NO_REQUEST_ID_PROVIDED_ERROR_CODE = 509;		


	public static final String NO_TP_USER_ID_PROVIDED_ERROR_MESSAGE ="No TP userID Provided !";
	public static final int NO_TP_USER_ID_PROVIDED_ERROR_CODE = 510;
	
	public static final String INVALID_REQUEST_DATA_ERROR_MESSAGE ="Invalid Request Data Provided !";
	public static final int INVALID_REQUEST_DATA_ERROR_CODE = 511;
	
	public static final String TICKET_NUMBER_NOT_PROVIDED_MESSAGE = "Please provide ticket number";
	public static final int TICKET_NUMBER_NOT_PROVIDED_ERROR_CODE = 509;
	
	public static final String VIRN_NUMBER_NOT_PROVIDED_MESSAGE = "Please provide virn number";
	public static final int VIRN_NUMBER_NOT_PROVIDED_ERROR_CODE = 510;
	
	public static final String USER_ID_NOT_PROVIDED_MESSAGE = "Please provide user id";
	public static final int USER_ID_NOT_PROVIDED_ERROR_CODE = 511;
	
	public static final String REQUEST_ID_NOT_PROVIDED_MESSAGE = "Please provide request id";
	public static final int REQUEST_ID_NOT_PROVIDED_ERROR_CODE = 512;
	
	public static final String INVALID_USER_ERROR_MESSAGE = "Invalid User";
	public static final int INVALID_USER_ERROR_CODE = 513;
	
	public static final String VIRN_NUMBER_INVALID_ERROR_MESSAGE = "Invalid virn number";
	public static final int VIRN_NUMBER_INVALID_ERROR_CODE = 514;
	
	public static final String LIMIT_EXCEEDED_ERROR_MESSAGE = "Limit Exceeded";
	public static final int LIMIT_EXCEEDED_ERROR_CODE = 515;
