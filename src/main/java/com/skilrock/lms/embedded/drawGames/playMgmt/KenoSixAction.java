...
public class KenoSixAction extends ActionSupport implements ServletRequestAware , ServletResponseAware {
...
*/
		...
		if("SUCCESS".equalsIgnoreCase(kenoPurchaseBean.getSaleStatus())){
			String smsData = com.skilrock.lms.common.utility.CommonMethods.prepareSMSData(kenoPurchaseBean.getPlayerData(), kenoPurchaseBean.getPlayType(), new StringBuilder(String.valueOf(kenoPurchaseBean.getTotalPurchaseAmt())), new StringBuilder(kenoPurchaseBean.getTicket_no()).append(kenoPurchaseBean.getReprintCount()), kenoPurchaseBean.getDrawDateTime());
