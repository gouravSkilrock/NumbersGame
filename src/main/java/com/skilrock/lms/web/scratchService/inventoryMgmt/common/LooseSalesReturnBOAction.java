...
import com.skilrock.lms.coreEngine.scratchService.inventoryMgmt.common.LooseSaleReturnBOHelper;

public class LooseSalesReturnBOAction extends ActionSupport implements
	...
	public String dispatchOrder() {
		...
		LooseSaleReturnBOHelper boHelper = new LooseSaleReturnBOHelper();

		int agentOrgId = Integer.parseInt(userName.split(":")[0]);
		boHelper.looseSaleReturnForBo(gameName, NumTickets, ticketAmt,
				ticketComm, agentOrgId, userInfoBean, rootPath);
		return SUCCESS;
	}
