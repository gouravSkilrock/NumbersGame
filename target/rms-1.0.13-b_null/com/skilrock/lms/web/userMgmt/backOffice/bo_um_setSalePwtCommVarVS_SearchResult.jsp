		...
		<div id="all" style="display: none;">
			<table style ='width="90%"; border="0"; cellpadding="3"; cellspacing="0"; bordercolor="#CCCCCC"; align="center"'>
				<tr>
					...
					<td align="right"><input type="button" name='button' id="submitbutoon" value="<s:text name="label.update.all"/>" style = 'align="right";' disabled="disabled" style="button" onclick="submitUpdatedValueVS()" /></td>
				</tr>
			</table>
		</div>
	</s:if>
