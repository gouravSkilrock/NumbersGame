...
_id.hid('subTrans');_id.hid('verBk');
if(validateData()){
url = "agt_om_bookRecieveRegistration_VerifyBooks.action?"+countGmBks();
...
function fetchDet(){
	...
	var _resp  = _ajaxCall("getGameNameAgent.action");
	if(_resp.result){
	_respData=_resp.data;
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/orderMgmt/agent/js/agt_om_bookRecieveRegistration.js,v $'] = '$Id: agt_om_bookRecieveRegistration.js,v 1.3 2016/10/31 09:46:23 neeraj Exp $';
