		...
		<s:form action="bo_om_closeOrder_Search">
			<table cellpadding="2" cellspacing="0" border="0">
				...
				<tr>
				 ...
				 <tr>
					<s:select cssClass="option" headerKey="1" headerValue="-- Please Select --" label="Order Status" name="orderStatus" list="{'Semi Processed','Approved','Assigned'}"></s:select>
				</tr>
				<tr>
