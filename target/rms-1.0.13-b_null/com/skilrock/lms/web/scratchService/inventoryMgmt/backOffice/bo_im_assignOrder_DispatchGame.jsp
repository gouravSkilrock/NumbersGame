				...
				<s:form name="dspchOrderGame">
					...
					<table border="1" align="center" cellpadding="3" cellspacing="0"
						...
						<tr>
							...
							<th colspan="2">
								Total Assigned Books to <s:property value="#application.TIER_MAP.RETAILER" /> by the <s:property value="#application.TIER_MAP.AGENT" />
							</th>
							<td colspan="2">
						...
						<tr>
							...
							<th colspan="2">
								Total Assigned Books to <s:property value="#application.TIER_MAP.AGENT" /> by the BO
							</th>
							<td colspan="2">
						...
						<tr>
							...
							<th>
								Number of Books Already Assign
							</th>
							<td>
					...
					<s:if test="%{!isProceedNext}">
						...
						<table border="0" cellpadding="3" width="86%" align="center"
							cellspacing="0" bordercolor="#CCCCCC">
					...
					<s:submit value="Proceed to Next Game" action="bo_im_assignOrder_ProceedNxtGame"
...
$RCSfile: bo_im_assignOrder_DispatchGame.jsp,v $
$Revision: 1.3 $
</code>