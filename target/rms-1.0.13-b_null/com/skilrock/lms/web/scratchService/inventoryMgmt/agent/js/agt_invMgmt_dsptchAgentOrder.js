...
// alert("game number is  " + gameNumber);
 ...
 document.getElementById("loadingDiv").style.visibility="visible";
  ...
  url = "agt_im_assignOrder_VerifyBookSeries.action?gameNbr="+gameNumber+" & gameId="+gameId+" & bookNbrFromArr="+bookNbrFrom +"&bookNbrToArr =" + bookNbrTo+"&bookNbr =" + agentBooks ;
  //alert("url is --" + url);
...
function verifyAgentPack(packNbr,div) {
  ...
  url = "agt_im_assignOrder_VerifyPack.action?gameNbr="+gameNumber+" & gameId="+gameId+"&packNbrToVerify="+ packNbr+ "&packNbr =" + agtPacks +"& packCountId = " + div ;
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/inventoryMgmt/agent/js/agt_invMgmt_dsptchAgentOrder.js,v $'] = '$Id: agt_invMgmt_dsptchAgentOrder.js,v 1.3 2016/10/31 09:46:47 neeraj Exp $';
