...
function validateGameNumber() {
	...
	if(isNaN(num)){			
		document.getElementById("gameNumber1").innerHTML = "<font color=red>"+i18nObj.prop('error.pls.enter.numeric.value')+"</font>";
		return false;
		}else {
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/inventoryMgmt/backOffice/js/inventoryReport.js,v $'] = '$Id: inventoryReport.js,v 1.3 2016/10/31 09:46:19 neeraj Exp $';