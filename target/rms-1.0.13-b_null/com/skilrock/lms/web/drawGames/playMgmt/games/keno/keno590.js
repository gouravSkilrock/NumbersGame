...
function _kenoFillWinTbl(){ 
	...
	var _kenoWinHTML='<table width="100%" border="0" bordercolor="red" style="margin-top:3px"><tr><td><div style="'+scrollColor("#2f8ebd","#1f6588","190")+'">';	
	...
	if(!winArr[i].match("Result")){
		...
		var htm='<table width="90%" border="0" bordercolor="green" id="result'+i+'" cellspacing="2" cellpadding="10" class="keno_winningResult_table" ><tr><td class="kenowinningResultTime" colspan="8" height="60">'+newTime+'</td></tr><tr>';
		...
		var htm='<table width="90%" bordercolor="blue" border="0" cellspacing="2" cellpadding="10" id="result'+i+'" class="keno_winningResult_table" ><tr><td class="kenowinningResultTime" colspan="8" height="60" >Result Awaited</td></tr><tr>'
		htm=htm+'<td class="selected_win_keno_numbers" style="padding-left:55px"  colspan="8"><div style="text-align:center" id="winAwaitedDiv" style="color:#663300"></div></td>';
		htm=htm+'</tr></table>';		
		_kenoWinHTML=_kenoWinHTML+htm;
	}
...
var htm = '<div id=""><table width="99%" border="0" cellspacing="0" cellpadding="0" bgcolor="#639cce" style="margin-top:5px;margin-bottom:3px"><tr>';
	...
	for(var i=1;i<parseInt(6)+1;i++){
		htm=htm+'<tr id="row'+i+'">';
			for(var j=0;j<5;j++){
				...
				htm=htm+'<td><input type="text" class="'+className+'" maxlength="2" '+disableVal+'  onkeydown="return keyPressKeno(this)" onkeyup="return keyPressKeno(this)"  onblur="blurFnKeno(this)"></td>';
...
function buyTicketKeno(){
	...
	if(_id.o('qpVal').value=="No"){
		...
		if((pickDataArr.length<parseInt(pickType))&& pickType!=30){
