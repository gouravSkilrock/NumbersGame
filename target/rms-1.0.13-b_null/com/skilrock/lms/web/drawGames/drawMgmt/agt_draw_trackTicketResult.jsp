								...
								<!-- 	<tr class="data">
									...
									<tr class="data">
										...
										<td align="left"><%=drawStatus
											...
											: panelBean.getStatus().replaceAll("_", " ")%></td>
										<td align="left">
											<%
												Object finalAmt;
...
<%
					...
					<table width="100%" border="1" cellpadding="3" cellspacing="0"
						...
						<td align="center"><%=drawBean.getDrawDateTime()%></td>
							<%
								if (!drawStatus.equals("CANCEL")) {
							%>
							<td align="center" style="word-wrap:break-word; word-break:break-all; width:86px;"><%=drawBean.getWinResult()==null?"RESULT AWAITED":drawBean.getWinResult()%></td>
							<%
								} else if ("CANCEL".equalsIgnoreCase(drawStatus)) {
							%>
							<td align="center">
							...
							<td align="center" style="word-wrap:break-word; word-break:break-all; width:86px;"><%=drawBean.getDrawStatusForticket().replaceAll("_", " ")%></td>
							...
							<td colspan="4">
								<table width="100%" border="1" cellpadding="3" cellspacing="0"
									...
									<tr class="data">
										...
										<td align="left" style="word-wrap:break-word; word-break:break-all; width:86px;" ><%=panelBean.getPickedData().replace("-1",
										"XX")%></td>
										<%
											if ("Keno".equalsIgnoreCase(Util.getGameType(gameNo))
																|| "Zimlottotwo".equalsIgnoreCase(Util
										...
										<td align="left"><%=partyIdMap.get(panelBean
											...
											: partyIdMap.get(panelBean
													.getPartyId())%></td>
										<td align="left" style="word-wrap:break-word"><%=drawStatus
											.equalsIgnoreCase("CLAIM HOLD") ? "N.A."
											: panelBean.getStatus().replaceAll("_", " ")%></td>
