...
<s:if test="#session.reportList.size>0">
				<s:div id="excel"
					...
					<s:a href="bo_rep_drawSaleReport_exportExcel.action?reportType=Game Wise&start_date=%{#startDate}&end_Date=%{#endDate}&stateCode=%{#state}&cityCode=%{#city}"><s:text name="btn.exportasexcel"/></s:a>
				</s:div>
</s:if>
