...
_id.hid('subTrans');_id.hid('verBk');
if(validateData()){
url = "ret_om_bookRecieveRegistration_VerifyBooks.action?"+countGmBks();
...
function fetchDet(){
	...
	var _resp  = _ajaxCall("getGameNameRetailer.action");
	if(_resp.result){
	_respData=_resp.data;
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/orderMgmt/retailer/js/ret_om_bookRecieveRegistration.js,v $'] = '$Id: ret_om_bookRecieveRegistration.js,v 1.3 2016/10/31 09:47:06 neeraj Exp $';
