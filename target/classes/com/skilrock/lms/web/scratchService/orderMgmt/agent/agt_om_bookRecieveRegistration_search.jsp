...
<html>
	...
	<body>
		<s:if test="#session.GAME_BOOK_MAP.size()!=0">
			<s:form name="retGameBookDetails" action="agt_om_bookRecieveRegistration_Success"
				...
				<table border="1"  cellpadding="5" style="border-collapse: collapse;color: #4d4d4d; background-color: #FFFFFF" width="100%">
					<tr>
						<td>
							Number of games :
				...
				<table width="100%" border="1" cellpadding="3" cellspacing="0"
					bordercolor="#666666"
					style="border-collapse: collapse; color: #4d4d4d ;background-color: #FFFFFF" align="center">
					<tr>
						<td>
						...
						<tr>
							<td>
								<table width="100%" id="<s:property value="%{key}" />"
									...
									<tr>
										<th style="font-size: 12px;" colspan="5" align="center">
											<input type="checkbox"
...
<code id="headId" style="visibility: hidden">
	$RCSfile: agt_om_bookRecieveRegistration_search.jsp,v $ $Revision: 1.3 $
</code>