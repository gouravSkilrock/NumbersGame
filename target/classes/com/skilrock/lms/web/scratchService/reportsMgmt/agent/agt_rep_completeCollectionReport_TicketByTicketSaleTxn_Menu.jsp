	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				...
				<div id="main-heading" style="display: none">Collection Report Retailer Wise
					<%-- <s:text name="label.agent.wise.sale.report.heading.in.excel"/> --%>
				</div>
				<s:form action="agt_rep_TicketByTicketSaleTxn_Search" onsubmit="return validateDates()">
					<table width="450" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							...
							<div id="date" style="display: block; text-align: left; width: 60%">
									<s:div id="newDates" theme="ajax" href="rep_common_fetchDate.action">
									</s:div>
								</div>
							</td>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/js/Export_Excel_Safaribet.js"></script>
	</body>
</html>
