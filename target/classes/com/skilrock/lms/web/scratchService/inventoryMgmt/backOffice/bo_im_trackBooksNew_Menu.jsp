...
<body>
	...
	<div id="wrap">
		<div id="top_form">
			<h3>
				<s:text name="label.track.books" />
			</h3>
			<s:form action="bo_im_trackBooksNew_Detail" onsubmit="return checkValidation()">
				<table>
					<tr>
						<td>
							<div id="gameStatusId1"></div> <s:select
								list="{'--Please Select--','OPEN','CLOSE','TERMINATE','SALE_HOLD','SALE_CLOSE'}"
								cssClass="option" id="gameStatusId" key="label.slct.game.status"
								onchange="retrieveURL('bo_im_trackBooks_GameList.action?status=' + this.value,'characters')"
								onclick="clearDiv(this.id)"></s:select></td>
					</tr>
					<tr>
						<td colspan="3" align="center">
							<div id="gameNameId1"></div> <span id="characters">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:text
									name="label.slct.game" /> : <select class="option"
								name="gameNameNbr" id="gameNameId">
					...
					<tr>
						<td>
							<div id="bookNumberId1"></div> <s:textfield name="bookNumber"
								id="bookNumberId" key="label.entr.book.no"
								onfocus="clearDiv(this.id)"></s:textfield></td>
					</tr>
					<tr>
...
<code id="headId" style="visibility: hidden"> $RCSfile:
	bo_im_trackBooksNew_Menu.jsp,v $ $Revision: 1.3 $ </code>