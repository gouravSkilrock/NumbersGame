   ...
   <body>
	...
	<div id="wrap">
		<div id="top_form">
			...
			<s:form action="agent_rep_retailers_incentive_search" onsubmit="return validate();">
				<table>	
				<tr><td id="err" style="color: red;"></td></tr>
					<tr>
						<td>
							<table>
								<tr><td>
									<s:select name="reportType" key="label.slct.type" headerKey="-1" headerValue="--Please Select--"
										list="#{'Daily':getText('label.daily')}" 
										cssClass="option" onchange="setDateField(this.value)" id="selectType"/>
								</td></tr>		
							</table>
						</td>
					</tr>
					<tr id="daily_start_date" style="display:none;">
						<td>
							...
							%>
							<label class="label" style="margin: 3px;"><s:text name="label.slct.date" /><span style="color:red;">*</span>:&nbsp;</label>
...
<code id="headId" style="visibility: hidden">
	$RCSfile: agent_rep_incentive_Menu.jsp,v $ $Revision:
	1.1.2.4 $
</code>