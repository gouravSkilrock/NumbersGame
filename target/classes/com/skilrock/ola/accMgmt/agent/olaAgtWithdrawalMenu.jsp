				...
				<div id="first">
					<s:form action="olaAgtWithdrawal_Save" onsubmit="return verifyWithdrawl()">
						...
						<table border="0" cellpadding="2" cellspacing="0" width="400px">
							...
							<tr>
								<td>
									<s:textfield name="withdrawalReqBean.refCode" label="Mobile Number" id="refCode" maxlength="%{mobileNumberlimit}"/></td>
...
<code id="headId" style="visibility: hidden">
	$RCSfile: olaAgtWithdrawalMenu.jsp,v $ $Revision: 1.3 $
</code>